...
export function basicQuoteTemplateBody(): Block[] {
  return [
    ...
    // Products table
    {
      ...
      show_thumbnail: true,
      column_configs: [
        { col_key: 'name',        align: 'left' },
        { col_key: 'sku',         width: 'md', align: 'left' },
        { col_key: 'cantidad',    width: 'sm', align: 'right' },
        { col_key: 'unit_price',  width: 'md', align: 'right' },
        { col_key: 'subtotal',    width: 'md', align: 'right' },
      ],
      show_totals: false,
    },
