...
import type { BoardItemsData } from './types'

type Props = { itemId: string; viewId: string; viewName: string; compact?: boolean }

export function BoardItemsRenderer({ itemId, viewId, viewName }: Props) {
